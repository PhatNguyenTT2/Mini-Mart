        ...
        <div className="flex flex-wrap gap-1.5 ml-9 mt-1 animate-fade-in">
          {suggestedPrompts.map((prompt, i) => (
            <button
              ...
              className="text-xs px-2.5 py-1 rounded-full border border-gray-200 text-gray-500 bg-white hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-600 hover:scale-[1.03] active:scale-[0.97] transition-all duration-150 cursor-pointer"
            >
              {prompt}
            </button>
          ))}
