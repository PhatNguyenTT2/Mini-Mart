...
export const ProductListHeader = ({
  ...
  const hasActiveFilters = categoryFilter || statusFilter !== 'all' || vendorFilter;
              ...
              <div className="absolute left-0 mt-2 w-64 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                ...
                <div className="px-4 py-3">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      onCategoryFilterChange && onCategoryFilterChange(e.target.value);
                    }}
                ...
                <div className="px-4 py-3">
                  ...
                  <input
                    ...
                    value={vendorFilter}
                    onChange={(e) => {
                      onVendorFilterChange && onVendorFilterChange(e.target.value);
                    }}
                    placeholder="Search vendor..."
                    className="w-full h-[32px] bg-white border border-[#ced4da] rounded-lg px-2 py-1 text-[12px] font-['Poppins',sans-serif] text-[#212529] focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                  />
                </div>
