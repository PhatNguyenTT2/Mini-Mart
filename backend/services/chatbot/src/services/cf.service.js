...
class CollaborativeFilteringService {
    ...
    async computeItemSimilarities(storeId, minCommonUsers = 2) {
        ...
        // Step 1: Merge Implicit Feedback (Dual-Tracking Organic Data)
        await this.pool.query(`
            WITH implicit AS (
                ...
                GROUP BY user_id, product_id, store_id
            )
            ...
            DO UPDATE SET interaction_score = user_product_interaction.interaction_score
                + EXCLUDED.interaction_score
        `, [storeId]);

        // Step 2: Load all interactions into memory
