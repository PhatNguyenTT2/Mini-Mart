...
async function cleanup() {
  ...
  try {
    ...
    if (!aprioriOk) {
      console.log('      ⚠ Run: node docs/chatbot/seed-product/seed-ml-benchmark.js --spec docs/chatbot/seed-product/benchmark-spec-v4.json --store-id 1 --seed 42 --confirm-rebuild');
    }
